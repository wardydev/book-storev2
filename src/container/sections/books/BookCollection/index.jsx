                ...
                <div className="flex items-center">
                    <div className="px-6 py-2 border border-gray-200 flex justify-between items-center rounded-tl-lg rounded-bl-lg w-full w-5/6">
                        <div className="flex space-x-4">
                            ...
                            <Link to="/books" className="text-gray-500">This Week</Link>
                            <Link to="/books" className="text-gray-500">This Month</Link>
                        </div>
                    ...
                    <div className="px-6 py-2 border-t-2 border-r-2 border-b-2 border-gray-200 flex justify-center items-center rounded-tr-lg rounded-br-lg space-x-4">
