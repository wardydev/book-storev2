    ...
    return (
        <section className="px-20 pt-8">
            <div className="flex space-x-8 items-center">
                {/* img */}
                <img src={ImageDetail} alt="" className="rounded-lg" width="300" />
                {/* detail */}
                <div className="w-full">
                    ...
                    <div className="flex justify-between items-center mt-10 mb-6">
                        ...
                        <div className="flex items-center space-x-4">
                            <button className="py-2 px-6 bg-purple-100 hover:bg-purple-200 text-purple-600 font-bold rounded-lg">FREE SHIPING</button>
                            <button className="py-2 px-6 bg-green-100 hover:bg-green-200 text-green-600 font-bold rounded-lg">IN STOCK</button>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-between items-center mt-6">
                        ...
                        <div className="flex items-center space-x-5">
                            ...
                            <button className="py-2 px-6 bg-purple-500 hover:bg-purple-600 text-gray-50 rounded-lg font-medium">Add to chart</button>
