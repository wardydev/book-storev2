...
export default function DetailsBook() {
    ...
    return (
        <section className="px-6 lg:px-20 pt-8">
            <div className="flex flex-col lg:flex-row space-x-0 lg:space-x-16 items-start">
                {/* img */}
                    ...
                    <div className="flex flex-col lg:flex-row w-full lg:w-auto justify-between items-start lg:items-center mt-12 lg:mt-6">
                        ...
                        <div className="flex items-center w-full lg:w-auto justify-between lg:justify-start space-x-5">
                            <div className="py-2 px-3 border rounded-lg border-gray-200 flex items-center">
                                ...
                                <svg onClick={() => setProductCount(prevState => prevState + 1)} xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-purple-600 cursor-pointer" viewBox="0 0 20 20" fill="currentColor">
                                <path fillRule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clipRule="evenodd" />
                                </svg>

                                <span className="font-bold px-8">{productCount}</span>

                                <svg onClick={handleDecrement} xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-purple-600 cursor-pointer" viewBox="0 0 20 20" fill="currentColor">
