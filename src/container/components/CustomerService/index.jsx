            ...
            <div className="flex justify-between items-center">
                ...
                <div className='w-2/5'>
                    <div className='flex items-center space-x-2 mb-2'>
                        ...
                        <div className="h-2 w-full rounded-lg bg-purple-200 relative">
                            <div className="h-2 bg-purple-500 rounded-lg absolute left-0 top-0 z-10 w-3/4"></div>
                        </div>
                    ...
                    <div className='flex items-center space-x-2 mb-2'>
                        ...
                        <div className="h-2 w-full rounded-lg bg-purple-200 relative">
                            <div className="h-2 bg-purple-500 rounded-lg absolute left-0 top-0 z-10 w-3/5"></div>
                        </div>
                    ...
                    <div className='flex items-center space-x-2 mb-2'>
                        ...
                        <div className="h-2 w-full rounded-lg bg-purple-200 relative">
                            <div className="h-2 bg-purple-500 rounded-lg absolute left-0 top-0 z-10 w-2/5"></div>
                        </div>
                    ...
                    <div className='flex items-center space-x-2 mb-2'>
                        ...
                        <div className="h-2 w-full rounded-lg bg-purple-200 relative">
                            <div className="h-2 bg-purple-500 rounded-lg absolute left-0 top-0 z-10 w-1/4"></div>
                        </div>
                    ...
                    <div className='flex items-center space-x-2 mb-2'>
                        ...
                        <div className="h-2 w-full rounded-lg bg-purple-200 relative">
                            <div className="h-2 bg-purple-500 rounded-lg absolute left-0 top-0 z-10 w-1/12"></div>
                        </div>
