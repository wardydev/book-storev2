    ...
    return (
        <div>
            <div className='flex items-center justify-between mb-8'>
                <h4 className="font-medium">Showing 4 of 20 Reviews</h4>
            ...
            <div>
                ...
                <div className="border rounded-lg border-gray-300 p-8 flex flex-col lg:flex-row items-center justify-between space-x-0 lg:space-x-6 mb-4">
                    ...
                    <div className='text-center'>
                        <h3 className="text-2xl font-medium text-yellow-500 mb-1">4.0</h3>
                ...
                <button className="py-3 rounded-lg bg-purple-500 text-gray-50 w-full hover:bg-purple-600">View More</button>
